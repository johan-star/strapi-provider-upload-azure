...
module.exports = {
  ...
  auth: {
    ...
    useHashAsFileName: {
        label: 'Use Hash as file name in Azure',
        type: 'enum',
        values: ['No', 'Yes']
    }
  },
      ...
      upload: (file) => {
        return new Promise((resolve, reject) => {
          function process(file){
            var fileName = (config.useHashAsFileName == 'No' ? file.name : file.hash) + file.ext;
            ...
            .then(function(){
              ...
              .then(function(image){
                ...
                .then(function(_buffer){
                  ...
                  file.url = file.url.replace(config.useHashAsFilename == 'No' ? file.name : file.hash, 'thumb-' + config.useFilenameAsHash == 'No' ? file.name : file.hash);
